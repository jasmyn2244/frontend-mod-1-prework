...
// EXPLAIN:
//0,1,2 will be logged. The computer will start with the index (0), check to see if it's less than 1, print it and add 1. It will then repeat this for 1, and 2, but when it gets to 3 it will stop
